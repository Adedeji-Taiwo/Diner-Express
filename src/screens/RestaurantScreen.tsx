...
import { RestaurantScreenRouteProp } from '../types'
import { urlFor } from '../../sanity'
import { ArrowLeftIcon, StarIcon } from 'react-native-heroicons/solid'
import {MapPinIcon, ChevronRightIcon, QuestionMarkCircleIcon} from 'react-native-heroicons/outline';
...
const RestaurantScreen = () => {
   ...
   //used when UI essentially loads
    ...
    //dispatch restaurant data from here to basket reducer
    useEffect(() => {
    ...
    <ScrollView>
      <View className='relative'>
            ...
            <TouchableOpacity
                ...
                <ArrowLeftIcon size={20} color="#0dccbb" />
            </TouchableOpacity>
      </View>
